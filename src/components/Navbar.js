    ...
    <div className="nav">
      <ul className="nav-links">
        {navLinks.map((link, idx) => {
          ...
          return <li className={isActive ? "nav-link-active" : "nav-link"} key={`${link.name}-${idx}`}><Link to={link.path}>{link.name}</Link></li>
        })}
        <li>
          <a className="link" href="https://github.com/DanishShah">
        ...
        <li>
          <a className="link" href="https://dribbble.com/da9ish">
            <svg style={{ width: "24px", height: "24px" }} viewBox="0 0 24 24">
